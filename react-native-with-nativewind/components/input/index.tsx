...
const inputStyle = tva({
  base: 'border-background-300 flex-row overflow-hidden content-center justify-between data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300',
...
const inputSlotStyle = tva({
  base: 'justify-center items-center web:disabled:cursor-not-allowed px-1',
});

const inputFieldStyle = tva({
  base: 'flex-1 text-typography-900 dark:text-typography-900 web:cursor-text web:data-[disabled=true]:cursor-not-allowed py-auto px-3 placeholder:text-typography-500 dark:placeholder:text-typography-500',
