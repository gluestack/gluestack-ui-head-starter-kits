...
const Checkbox = React.forwardRef(
  (
    {className, size = 'md', ...props}: {className?: string} & ICheckboxProps,
    ref,
  ) => {
    return (
      <UICheckbox
...
const CheckboxLabel = React.forwardRef(
  ({className, ...props}: {className?: string} & ICheckboxLabelProps, ref) => {
    const {size: parentSize} = useStyleContext();
    return (
      <UICheckbox.Label
...
const CheckboxIcon = React.forwardRef(
  (
    {className, as: AsComp, ...props}: ICheckboxIconProps & {className?: any},
    ref,
  ) => {
    const {size: parentSize} = useStyleContext();
    if (AsComp) {
